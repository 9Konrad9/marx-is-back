...
const MEISTER_TEXTE = {
  weber: [
    ...
    [ 'Zugenagelt. Ja. Sieh dich ruhig um.',
    ...
    [ 'Frag mich nicht nach Arbeit, ich habe selbst keine.',
  ...
  schuster: [
    [ 'Schuhe, Stiefel, Reparaturen. Alles von Hand, alles hier in der Werkstatt.',
      ...
      'Komm in fünf Jahren wieder, dann stehe ich immer noch hier.' ],
    [ 'Sag nichts. Ich weiß, was ich damals gesagt habe.',
